package com.tensquare.spit.recruit.service;

import com.tensquare.spit.recruit.dao.EnterpriseDao;
...
public class EnterpriseService {
	 ...
	 * @return
	 */
    public List<Enterprise> findHotList(String hotList) {
		return enterpriseDao.findByIshot(hotList);
    }
}
